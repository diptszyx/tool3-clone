  ...
  try {
    ...
    if (error instanceof Error) {
      ...
      if (error.message.includes('Invalid Mint')) {
        errorMessage =
          'Invalid mint account. The mint may not exist or may not be properly initialized.';
      } else if (error.message.includes('Could not determine token program')) {
        errorMessage =
          'Could not determine the correct token program for this mint. Please ensure the mint exists.';
