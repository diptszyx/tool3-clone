    ...
    try {
      ...
      for (const tokenMint of values.selectedAccounts) {
        ...
        if (tokenAccountInfo.isFrozen) {
          throw new Error(
            `Token account ${tokenAccount.toString()} is frozen and cannot be closed`,
          );
        }
        ...
        transaction.add(
          createCloseAccountInstruction(tokenAccount, publicKey, publicKey, [], TOKEN_PROGRAM_ID),
        );
      }
          ...
          <div className="space-y-4 flex flex-col items-center">
            {tokensLoading ? (
              ...
              <div className="text-center text-gray-600">
                No zero-balance accounts found. Try connecting a different wallet or switching
                clusters.
              </div>
            ) : (
