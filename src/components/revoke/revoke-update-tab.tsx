...
export function RevokeUpdateTab({
  tokenAddress,
  tokenInfo,
  publicKey,
  signTransaction,
  ...
  return (
    <div className="space-y-4 pt-4">
      <Alert variant="destructive">
        ...
        <AlertDescription>
          Once you revoke update authority, no one can ever update token metadata (name, symbol,
          URI). This action cannot be undone.
        </AlertDescription>
      </Alert>
      ...
      <div className="space-y-2">
        ...
        <ul className="text-sm text-muted-foreground list-disc list-inside space-y-1">
          ...
          <li>Increases trust and decentralization</li>
          <li>Only available for Token-2022 with metadata extension</li>
        </ul>
      </div>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="space-y-2">
              <p>
                This will <strong>permanently revoke</strong> your update authority. You will never
                be able to update token metadata.
              </p>
