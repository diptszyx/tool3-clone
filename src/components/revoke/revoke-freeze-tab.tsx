...
export function RevokeFreezeTab({
  ...
  const handleRevoke = async () => {
    const success = await revokeFreezeAuthority();
    if (success) {
      setIsDialogOpen(false);
    }
  };
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="space-y-2">
              <p>
                This will <strong>permanently revoke</strong> your freeze authority. You will never
                be able to freeze token accounts.
              </p>
