...
import {
  ...
  SliderOptionType,
  TokenExtensionType,
} from '@/service/token/token-extensions/token-creation';
                      ...
                      {extension.id === 'transfer-fees' ? (
                        <div className="space-y-4">
                          <div className="space-y-2">
                            {extension.options
                              .filter((opt) => opt.id === 'fee-percentage')
                              .map((option) => {
                                const optionValue =
                                  tokenData.extensionOptions?.[extension.id]?.[option.id];
                                  ...
                                  <div key={option.id} className="space-y-1">
                                    <div className="flex items-center justify-between">
                                      <label className="text-sm font-medium">
                                        {option.label}:{' '}
                                        {(optionValue as number) || sliderOption.defaultValue}%
                                      </label>
                                      {error && (
                          ...
                          <div className="bg-gray-50 p-3 rounded-md mt-2">
                            <div className="flex items-start">
                              ...
                              <p className="text-xs text-gray-600">
                                Transfer fees are calculated as a percentage each time tokens are
                                transferred. When users transfer tokens, fees are automatically
                                deducted and sent to the configured Fee Receiver address.
                              </p>
                            </div>
                          </div>
                        </div>
